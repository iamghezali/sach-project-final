...
import CustomOrderImageUpload from '@/features/shop/custom-order/components/steps/custom-order-image-upload';
                ...
                <FieldSet>
                    <FieldGroup className="gap-8">
                        ...
                        <CustomOrderImageUpload
                            ...
                            onAppend={appendOrderItemImages}
                            onRemove={removeOrderItemImage}
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <FormButton
                                control={form.control}
                                disabled={(isSubmitted && !!imageError) || (isEditing && !isDirty && !imagesDirty)}
                                variant="brand-primary"
                                size="brand-md"
                            >
