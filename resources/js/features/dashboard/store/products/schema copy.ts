...
export const CreateProductVariantRequestSchema = (attributeCount: number) =>
    z.object({
        ...
        stock_quantity: z
            .string()
            .refine((val) => !isNaN(Number(val)), { message: 'Stock quantity must be a valid number' })
        ...
        price: z
            ...
            .refine((val) => Number(val) >= 1, { message: 'Price must be a positive number' }),
 ...
 */
export const AssignAttributesResponseSchema = apiResponseSchema(z.void());
